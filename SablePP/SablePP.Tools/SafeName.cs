...
namespace SablePP.Tools
{
    ...
    public class SafeName
    {
        ...
        /// <summary>
        /// Enumerates a collection of strings matching the pattern '<paramref name="name"/>', '<paramref name="name"/>1', '<paramref name="name"/>2', ...
        /// </summary>
        /// <param name="name">The name that should be prepended with integers.</param>
        /// <returns>An infinite collection of strings; '<paramref name="name"/>', '<paramref name="name"/>1', '<paramref name="name"/>2', ...</returns>
